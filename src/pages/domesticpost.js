...
export default function Domesticepost() {
    return (
        <div>
            <Nav></Nav>
            <Row>
                ...
                </svg>Domestic Lost or Found  Animals</h5>
                  </Col>
                ...
                <Row style={{paddingLeft: "300px"}}>
                    ...
                    <Col><Button variant="outline-dark" href="/createpostDomestic">Create Post</Button></Col>
...
<br></br>
      ...
      {Array.from({ length: 8 }).map((_, idx) => (
        <Col>
          <Card>
            <Card.Img variant="top" src="https://th.bing.com/th/id/R.3ab6956a157d3539865f44cdd2e573b2?rik=Zkzy4J%2bfsoiUyg&pid=ImgRaw&r=0" />
            <Card.Body>
