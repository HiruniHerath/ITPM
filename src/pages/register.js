...
export default function Register() {
  return (
    <section>
      ...
      <div style={{ backgroundImage: `url(${"https://t4.ftcdn.net/jpg/00/78/89/41/360_F_78894153_6vehwXxxFzCbIyFjmZdrtoqxk219gWnd.jpg"})`, width: "100%", objectFit: "cover", height: "100px" }}>
      </div>
      <h1 style={{ color: "#353535", textAlign: "center", paddingTop: "10px" }}>Paws</h1>
      <div>
